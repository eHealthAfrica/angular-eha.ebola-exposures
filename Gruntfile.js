module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    copy: {
      scripts: {
        ...
        rename: function(dest, src) {
          return dest + src.replace('scripts','ebola-exposures');
        }
      }
    },
    concat: {
      scripts: {
        ...
        options: {
          process: function(src, path) {
            ...
            return src.replace(/,\n    'angular-eha\.ebola-exposures\.template'/, '');
          }
        }
      },
    ...
    uglify: {
      dist: {
        files: {
          'dist/ebola-exposures.template.min.js': ['.tmp/scripts.template.js'],
          'dist/ebola-exposures.min.js': ['.tmp/scripts.js']
        }
      }
    },
    html2js: {
      dist: {
        ...
        module: 'angular-eha.ebola-exposures.template',
        options: {
